                   ...
                   struct pl_wflib_eeprom_ctx *e_ctx, int dataSource)
{
    ...
    if (dataSource == 4)
        {
        //return pl_dispinfo_init_UST(dispinfo);
            retval = (pl_dispinfo_init_UST(dispinfo)
                    || pl_wflib_init_UST(wflib));
            if (retval)
...
int probe_epdc(struct pl_platform *plat, struct it8951 *it8951, struct vcom_cal *vcom_cal)
{
